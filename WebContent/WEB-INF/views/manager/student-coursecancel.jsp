...
<script>
	$(document).ready(function() {		
		$("button.btnCancleCourse").on("click", function() {
			if (confirm("해당 과정의 수강을 취소하시겠습니까?")) {
				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li><a href="${pageContext.request.contextPath}/manager/student">수강생 관리</a></li>
							<li class="active">수강 취소</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">수강생 ${studentInfo.student_id}(${studentInfo.name_}/${studentInfo.ssn})의 수강 취소 가능한 과정 목록</strong>
							</div>
							<div class="card-body">
									...
									<c:forEach var="c" items="${cancelList}">
										<tr>
											...
											<td><a href="#"><button type="button"
														class="btn btn-info btn-sm btnCancleCourse" value="${c.oc_id}">취소하기</button></a></td>
										</tr>
									</c:forEach>
									</c:if>
									<c:if test="${cancelListCount==0}">									
										<tr>
											<td colspan="7">수강취소 가능한 과목이 없습니다</td>
										</tr>
									</c:if> 
									</tbody>
								</table>
