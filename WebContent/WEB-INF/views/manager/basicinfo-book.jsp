					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">등록된 교재 목록</strong>
								<button type="button"
									class="btn btn-info btn-sm btn-margin-left new"
									data-toggle="modal" data-target="#addBook">새로 등록</button>
							</div>
							<div class="card-body">
										...
										<c:forEach var="b" items="${textbookList_ds}">
											<tr>
												...
												<td><button type="button"
															class="btn btn-info btn-sm btnDeleteBook" value="${b.textbook_id}" ${(b.delete_status=='Y')?"":"disabled"}>삭제</button>
		...
		<div class="modal-dialog">
			...
			<form id="new insert" action="${pageContext.request.contextPath}/manager/basicinfo/book/insert" method="POST" >
				<div class="modal-header">
					<h4 class="modal-title">교재 정보 등록</h4>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="textbook_title" class=" form-control-label">교재명</label> <input
							id="textbook_title"  name="textbook_title" placeholder="교재명을 입력하세요" class="form-control" required>
					</div>
					<div class="form-group">
						<label for="publisher" class=" form-control-label">출판사</label> <input
							id="publisher" name="publisher" placeholder="출판사명을 입력하세요" class="form-control" required>
					</div>
					<div class="form-group">
						<label for="isbn" class=" form-control-label">ISBN</label> <input
							id="isbn" name="isbn" placeholder="ISBN을 입력하세요" class="form-control" required>
					</div>
