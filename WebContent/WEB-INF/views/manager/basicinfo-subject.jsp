				...
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown show active">
                        ...
                        <ul class="sub-menu children dropdown-menu show">
                            ...
                            <li class="active"><i class="fa fa-table"></i><a href="${pageContext.request.contextPath}/manager/basicinfo/subject">과목 관리</a></li>    
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">등록된 기초 과목 목록</strong><button type="button" class="btn btn-info btn-sm btn-margin-left"
													data-toggle="modal" data-target="#addSubject">새로
													등록</button>
							</div>
							<div class="card-body">
												...
												<tbody>
													<c:forEach var="s" items="${bsList_ds}">
														<tr>
															<td>${s.bs_id}</td>
															<td>${s.bs_name}</td>
															<td><a href="#"><button type="button" class="btn btn-info btn-sm btnDeleteSubject" value="${s.bs_id}" ${(s.delete_status=='Y')?"":"disabled"}>삭제</button></a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
			...
			<div class="modal-dialog">
				...
				<form id="new insert" action="${pageContext.request.contextPath}/manager/basicinfo/subject/insert" method="POST" >
					<div class="modal-header">
						<h4 class="modal-title">기초 과목 등록</h4>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="bs_name" class=" form-control-label">기초 과목명</label> <input
								id="bs_name" name="bs_name" placeholder="과목명을 입력하세요" class="form-control" required>
						</div>
