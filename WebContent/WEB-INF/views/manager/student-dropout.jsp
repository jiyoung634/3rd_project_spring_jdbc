				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li><a
								href="${pageContext.request.contextPath}/manager/student">수강생
									관리</a></li>
							<li class="active">중도탈락 처리</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">수강생 ${studentInfo.student_id}(${studentInfo.name_}/${studentInfo.ssn})의 중도 탈락
									가능한 과정 목록</strong>
							</div>
							<div class="card-body">
									...
									<c:forEach var="d" items="${dropoutList}">
										<tr>
											...
											<td><a href="#"><button type="button"
														...
														data-target="#student-dropout" value="${d.oc_id}">중도탈락처리</button></a></td>
										</tr>
									</c:forEach>
								 	</c:if> 
								 	<c:if test="${dropoutListCount==0}">
										<tr>
											<td colspan="7">중도탈락 가능한 과목이 없습니다</td>
										</tr>
									</c:if> 
									</tbody>
								</table>
