				...
				<ul class="nav navbar-nav">
					...
					<i class="menu-icon fa fa-bar-chart-o"></i>성적 조회
						...
						<ul class="sub-menu children dropdown-menu show">
                            <li class="active"><i class="fa fa-folder"></i><a href="${pageContext.request.contextPath}/manager/score/bycourse">과정별 성적 조회</a></li>     
				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li>성적 조회</li>
						<li><a href="${pageContext.request.contextPath}/manager/score/bycourse">과정별 성적 조회<!--</li--></a></li><li><a href="${pageContext.request.contextPath}/manager/score/bycourse/subjectlist?oc_id=${osInfo.oc_id}">과목별 성적 조회<!--</li--></a></li><li class="active">수강생 성적 조회</li></ol>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<strong class="card-title">${osInfo.oc_title}의 ${osInfo.os_name}(<c:set var="os_start_date" value="${osInfo.os_start_date}"/><c:if test="${os_start_date!=null}"><df:dateForm date="${osInfo.os_start_date}"/></c:if> ~ <c:set var="os_end_date" value="${osInfo.os_end_date}"/><c:if test="${os_end_date!=null}"><df:dateForm date="${osInfo.os_end_date}"/></c:if>) 수강생 성적 조회</strong>
